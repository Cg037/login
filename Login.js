...
if (localStorage.getItem("User") !== null) { 
    ...
    btn.innerHTML = "LOGGA UT"; document.body.appendChild(btn);
    
    // En knapp som loggar ut användaren och tömmer värden i storage och återskapar html-koden för formuläret.
...
function logIn() {
    ...
    // Jämför ifall de inmatade värderna stämmer med mina redan skapade inlogsvärden.
        ...
        // En knapp som vid felaktig inmatning återskapar första sedan med inloggningsformuläret.
